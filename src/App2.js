...
function App() {
  const web3 = new Web3(new Web3.providers.HttpProvider(`https://polygon-mainnet.infura.io/v3/512aa5e452cd4d549689b1be18a47853`))
  ...
  var Con_Address = "0x1948abC5400Aa1d72223882958Da3bec643fb4E5";
  const Contract = new web3.eth.Contract(abi, Con_Address)

  Contract.methods.userInfo(10,wallet.address).call((err,res)=>{console.log("number",res)})
